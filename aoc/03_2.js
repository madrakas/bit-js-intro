        ...
        xs.forEach(x => {
            ...
            if (x > 0){
                if(numbers.includes((rows[y][x - 1]))){              //left
                    // console.log(y, x - 1);
                    cogNumbers.push(numExtractor(y, x - 1));
                 }     
            }
            ...
            if (y > 0){
                if(numbers.includes((rows[y - 1][x]))){             //up
                    // console.log(y - 1, x);
                    cogNumbers.push(numExtractor(y - 1, x));
                }     
            }
            ...
            if ((y > 0) &&  (x > 0)){
                if(numbers.includes((rows[y - 1][x - 1]))){         //leftup
                    // console.log(y -1, x -1);
                    cogNumbers.push(numExtractor(y -1, x -1));
                }     
            }
            ...
            if (cogNumbers.length > 1){
                cogNumbers.forEach(cn => (cogRatio = cogRatio * cn));
                result += cogRatio;
            }
